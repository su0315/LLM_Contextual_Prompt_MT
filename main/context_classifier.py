...
def concatenate_lines(context_path, src_path):
...
model_checkpoint = "bert-large-cased"#"bert-base-cased"
...
training_args = TrainingArguments(
    output_dir="/mnt/data-poseidon/sumire/thesis/running/classifier/ja/2-1/large-4e-5_ep5",
    do_eval= True,
    do_predict= True,
    do_train=True, 
